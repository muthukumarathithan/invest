    ...
    return (
              <Fragment>
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-xl-3 col-md-6 xl-10">
                                ...
                                <div className="bg-warning card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Earnings</span>
                                            <h3 className="mb-0">$ <CountUp className="counter" end={665} /><small> This Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card o-hidden  widget-cards">
                                <div className="bg-secondary card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Returns</span>
                                            <h3 className="mb-0">$ <CountUp className="counter" end={985} /><small> This Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card o-hidden widget-cards">
                                <div className="bg-primary card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Wallet</span>
                            ...
                            <div className="card o-hidden widget-cards">
                                <div className="bg-danger card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Followers</span>
                                            <h3 className="mb-0">$ <CountUp className="counter" end={456} /><small> This Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
